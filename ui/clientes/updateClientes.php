...
$updateClientes = new Clientes($idClientes);
...
if(isset($_POST['update'])){
	$updateClientes = new Clientes($idClientes, $nombre, $apellido, $correo, "", "", $documento, $telefono, $latitud, $longitud, $dblp, $linkedIn, $twitter, $state, $rutas);
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/clientes/updateClientes.php") . "&idClientes=" . $idClientes ?>" class="bootstrap-form needs-validation"   >
						...
						<div class="form-check">
							<input type="radio" class="form-check-input" name="state" value="1" <?php echo ($updateClientes -> getState()==1)?"checked":"" ?>/>
							<label class="form-check-label">Habilitado</label>
						</div>
						<div class="form-check form-check-inline">
							<input type="radio" class="form-check-input" name="state" value="0" <?php echo ($updateClientes -> getState()==0)?"checked":"" ?>/>
